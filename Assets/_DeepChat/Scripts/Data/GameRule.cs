...
namespace _DeepChat.Scripts.Data
{
    ...
    public class GameRule : ScriptableObject
    {
        ...
        [Header("语料投放")] public int maxEmoticonCount = 8;
        ...
        public Emoticon SampleEmoticon(EmoticonBank bank, Func<SizeType, bool> contains)
        {
            ...
            {
                return bank.SampleBySize(SizeType.Short);
            }

            sample -= shortWeight;
            if (sample < mediumWeight)
            {
                return bank.SampleBySize(SizeType.Medium);
            }

            return bank.SampleBySize(SizeType.Long);
        }
    }
}